package com.teenagerslab.thebeat.CustomMethods.CustomMenu;
...
public class SmartMenu  extends ViewGroup implements View.OnClickListener,
   ...
   */
  private static final int DEFAULT_BTN_SIZE = 65;
  ...
  public SmartMenu(Context context, AttributeSet attrs) {
    ...
    mDotColor = ta.getColor(R.styleable.SmartMenu_dot_color, Color.parseColor("#eeeeee"));
    mShadowColor = ta.getColor(R.styleable.SmartMenu_shadow_color,Color.parseColor("#40000000"));
    mBackgroundColor = ta.getColor(R.styleable.SmartMenu_bg_color,Color.parseColor("#00ff0000"));
